...
class IndexController extends Controller
{
  ...
  public function __construct()
  {
    ...
    foreach ($sql as $mn) {
        ...
        array_push($this->menus, array('id' => $mn->id,'titulo' => $mn->titulo,'descripcion' => $mn->descripcion,'url' => $mn->url,'icono' => $mn->icono,'id_html' => $mn->id_html,'tipo_menu'=>$mn->tipo_menu,'target' => $mn->target,'submenus' => $submenu));
    }
