          ...
          <div class="white-box p-10">
              <div style="height: 450px;">
                  <h3 class="box-title"> lista de proyectos <b id="resultado_lita_resultado"></b>
                    ...
                    <span>Generar datos</span> <i class="fa fa-mail-forward m-l-5"></i>
                    </button>
                  </h3>
        ...
        $('#aplicar_filtro').click(function() {
         ...
         $('#graficar').click(function() {
            ...
            var idR = $("#resultados").val();
                ...
                if(lisCols != "") {
                     ...
                     selDimVal += (lisDimVal3)?lisDimVal3.value + ", ":'';
                      ...
                      $.ajax({
                              url: "{{url("/modulopdes/ajax/graficaall")}}",
                      ...
                      var source =
                      {
                          ...
                          id: 'id',
                          data:{'pilar':idP, 'meta': idM, 'resultado': idR,'filter':selDimVal},
                          url: "{{ url('/modulopdes/ajax/listaproyectos') }}"
                      };
                     ...
                     $("#jqxgridProyectos").jqxGrid(
                       {
                           ...
                           columns: [
                             ...
                             { text: 'Nombre Proyecto', datafield: 'nombre_proyecto', columntype: 'textbox'}
                           ]
                       });
          ...
          function precargarTotalDetalle(){
            ...
            selDimVal += (lisDimVal3)?lisDimVal3.value + ", ":'';
              $.ajax({
                      url: "{{ url('/modulopdes/ajax/totalesproyectosdetalle') }}",
                      type: "GET",
                      dataType: 'json',
                      data:{'filter':selDimVal, 'pilar':idP, 'meta': idM, 'resultado': idR},
                      success: function(date){
