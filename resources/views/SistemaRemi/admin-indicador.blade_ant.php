                    ...
                    var html = '<div id="ART'+codigo+'" class="row">'+
                                  '<div class="media row col-lg-12 ">'+
                                      ...
                                      '<div class="row col-lg-10">'+
                                          '<input type="text" name="id_resultado_articulado[]" value="" />'+
                                          '<input type="text" name="resultado_articulado[]" value="'+data.set[0].id_resultado+'" />'+
                                          '<input type="text" id="EST'+codigo+'" name="estado_resultado_articulado[]" value="1" />'+
