                        ...
                        <div class="col-md-1 p-l-0 p-r-0">
                          <label for="textarea" class="col-form-label control-label list-group-item-info" style="width: 100px;padding: 7px 95px 7px 3px;">Etapa</label>
                                              ...
                                              <div class="col-md-11 p-l-0">
                                                <label id="etapa_n" for="etapa_n" class=""></label>
                          

                        </div>
        <!--                                           <select id="etapa" name="etapa" class="custom-select col-12 form-control" disabled="disabled">
                                                      <option value="">Mostrar etapa...</option>
                      ...
                      <div class="form-group row m-b-10">
                        ...
                        <div class="col-md-11 p-l-0">
                            <input id="nombre" name="nombre" type="text" class="form-control"  placeholder="Nombre de indicador" disabled="disabled">
                            <div class="help-block with-errors"></div>
                        </div>
                      </div>
...
<!--                                       <li class="tab nav-item" hidden="hidden">
                                      ...
                                      <li class="tab nav-item">
                                          <a id="tab-ini5" data-toggle="tab" class="nav-link ctrl-btn" href="#info5" aria-expanded="false">
                                            <span class="visible-xs"><i class="fa fa-cloud-upload" style="font-size: 25px"></i></span>
                                            <span class="hidden-xs"><i class="fa fa-cloud-upload" style="font-size: 25px"></i> Viabilidad del Indicador</span>
                                          </a>
                                      </li>
                                     <li class="tab nav-item">
                                          <a id="tab-ini6" data-toggle="tab" class="nav-link ctrl-btn" href="#info6" aria-expanded="false">
                                            <span class="visible-xs"><i class="fa fa-cloud-upload" style="font-size: 25px"></i></span>
                                            <span class="hidden-xs"><i class="fa fa-cloud-upload" style="font-size: 25px"></i> Secretaria Técnica CIMPDS</span>
                                          </a>
                                      </li>
                                  </ul>
...
<!--                                                 <h5>Detalle de articulación</h5> -->                                     
                                          ...
                                          <p><h5>Ingrese los codigos ODS para agregar la articulación (Ayuda F10)</h5></p>                                                                                  
                                                <div class="row m-b-5 m-l-5 m-t-5" >
                                                    ...
                                                    <div class="form-group col-md-2 p-l-0">
                                                        <input id="cod_pilar" name="cod_pilar" type="text" class="form-control input" placeholder="Objetivo" data-inputmask="'alias': 'decimal', 'radixPoint': ',', 'groupSeparator': ',', 'autoGroup': false, 'digits': 0, 'digitsOptional': false, 'placeholder': '0'" style="text-align: right;">
                                                        <div class="help-block with-errors"></div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-2 p-l-0">
                                                        <input id="cod_resultado" name="cod_resultado" type="text" class="form-control input" placeholder="Indicador" data-inputmask="'alias': 'decimal', 'radixPoint': ',', 'groupSeparator': ',', 'autoGroup': false, 'digits': 0, 'digitsOptional': false, 'placeholder': '0'" style="text-align: right;">
                                                        <div class="help-block with-errors"></div>
                                                    </div>
  ...
  var idAV = [];
   ...
   /*   }else{
    ...
    $('#btn-back, .btn-back').click(function() {
       ...
       $("#datosART").html("");
       $("#fuente_datosN").val('').trigger('change');
       $("#fuente_datosD").val('').trigger('change');
       ...
       $.ajax({
             ...
             success: function(data){
               if(data.error == false){
                   ...
                   $("#etapa_n").val(data.indicador[0].etapa);
                   ...
                   if(data.indicador[0].fuente_datos){
                     $("#fuente_datosN").val(data.indicador[0].fuente_datos.split(",")).trigger('change');
                   }

                   if(data.indicador[0].fuente_datos_d){
                     $("#fuente_datosD").val(data.indicador[0].fuente_datos_d.split(",")).trigger('change');
                   }
