...
<div class="container row bg-white title">
  <h3>TABLERO <button class="btn btn-xs btn-success" id="btnGen">gen</button></h3>
...
@push('script-head')
  ...
  $("#btnGen").click(function(){
      $.get('/modulopriorizacion/ajax/itemstablero', function(res){
          console.log(res)
      })
  })
