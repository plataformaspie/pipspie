...
@section('content')
  ...
  <div class="tray tray-center p25 va-t posr">
      ...
      <div class="panel mb25 mt5">
          <div class="panel-heading">
              <span class="panel-title"> Metas Valores </span>
          </div>
  ...
  <div id="modal-editar" class=" popup-basic admin-form mfp-with-anim mfp-hide">
      <div class="panel">
          <div class="panel-heading">
              <span class="panel-title"><i class="fa fa-pencil"></i>Modificar Meta</span>
          </div>
...
@push('script-head')
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        ...
        var url = '{{ url('api/sistemasisgri/setMetas') }}';
        // prepare the data
        var source =
        {
            dataType: "json",
        ...
        $("#dataTable").jqxDataTable(
        {
            ...
            columnsResize: true,
            columns: [
              { text: 'Pilar', dataField: 'codigo', width: 100,cellsAlign: 'center' },
              { text: 'Codigo', dataField: 'cod_m', width: 100,cellsAlign: 'center' },
