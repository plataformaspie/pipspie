...
@section('content')
  ...
  <div class="row bg-title">
      ...
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
          <h4 class="page-title">Configurar perfil.</h4>
      </div>
      <!-- /.page title -->
      <!-- .breadcrumb -->
              ...
              <form id="formAdd" name="formAdd" action="javascript:save();" data-toggle="validator">
                {{ csrf_field() }}
                  <div class="form-group row">
                      ...
                      <div class="col-10">
                        <dl>
                            <dt>{{$users->username}}</dt>
                            <dd>Usuario asignado por el sistema</dd>
                        </dl>
                      </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                      <label for="example-text-input" class="col-2 col-form-label">Telefono(s) de referencia</label>
                      <div class="col-10">
