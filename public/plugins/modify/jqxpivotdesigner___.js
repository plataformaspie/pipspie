...
(function($) {
    ...
    $.extend($.jqx._jqxPivotDesigner.prototype, {
        ...
        createInstance: function(args) {
            ...
            host.append("<div class='" + hostClass + "' style='width: 100%; height: 100%; overflow:hidden; onselectstart='return false;' oncontextmenu='return false;''>\
            				<div class='labelFields jqx-widget' style='position: absolute;'>Campos p/pivot</div>\
            				<div class='labelFilters jqx-widget' style='position: absolute;'>Filtros</div>\
            				<div class='labelColumns jqx-widget' style='position: absolute;'>Columnas</div>\
            				<div class='labelRows jqx-widget' style='position: absolute;'>Filas</div>\
            				<div class='labelValues jqx-widget' style='position: absolute;'>Valores</div>\
...
/*
Funcion que llama al cargado de valores a partir de la modificacion del pivot;  funcion/es propia dentro de la aplicacion
 */
function afterRefreshPivotGrid(){
	funcionDespuesDePivotear();
}
