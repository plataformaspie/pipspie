(function(a) {
    ...
    a.extend(a.jqx._jqxPivotGrid.prototype, {
        ...
        createInstance: function(k) {
            ...
            c.append(j);
            this.contentCanvas = this.Canvas = j;
            this.hostVScroll = l.find("#divVScroll");
            this.hostHScroll = l.find("#divHScroll");
            this.hScroll = l.find("#divHScroll").jqxScrollBar({
                vertical: false,
                theme: this.theme
            });
            this.vScroll = l.find("#divVScroll").jqxScrollBar({
                vertical: true,
                theme: this.theme
            });
            m._createContextMenu();
            m.id = m._instanceId++;
            m._resizeLineId = "divResizeLine" + m.id;
            a(document.body).append("<div id='" + m._resizeLineId + "' style='position: absolute; display: none;'></div>");
            try {
                m.dataBind()
            } catch (i) {
                throw "Databinding exception: " + i.toString();
                return
            }
            m._installEventHandlers();
            a.jqx.utilities.resize(m.host, function() {
                m.refresh()
            }, false);
            if (!m._isInitialized) {
        ...
        _createContextMenu: function() {
            var l = this;
            var k = this.host;
            var j = k.find("#divContextMenu");
            l._contextMenu = j.jqxMenu({
                width: "120px",
            ...
            l._contextMenu.on("shown", function() {
                l._isContextMenuOpen = true
            });
            l._contextMenu.on("closed", function() {
                l._isContextMenuOpen = false;
                l._hideItemMenuElement()
            });
            l._contextMenu.on("itemclick", function(o) {
                o.stopImmediatePropagation();
                o.stopPropagation();
                var n = l._menuElement._itemMouseOver;
                if (!n) {
                    return
                }
                var m = n.hierarchy == l._pivotColumns ? l._pivotRows : l._pivotColumns;
                var i = o.args.innerHTML;
        ...
        dataBind: function() {
            ...
            function b(m, l, d, f, k) {
                for (var g in m.items) {
                    var j = m.items[g];
                ...
                for (var g in m.valueItems) {
                    var j = m.valueItems[g];
                    var e = new a.jqx.jqxPivotGrid.pivotItem(d, f);
                    e.adapterItem = j;
                    e.text = j.text;
                    e.isColumn = k;
        ...
        RenderGridContent: function() {
            ...
            var i = (this._pivotRows.isVisible() ? this._pivotRows.getWidth() : 0);
            var j = {
                width: this._pivotColumns.getWidth() + i,
                height: this._pivotRows.getHeight() + c
            };
            if (this.scrollableAreaSize != j || this.isSyncScrollRequired) {
                this.scrollableAreaSize = j;
                this.SynchronizeScrollBars()
            }
            var b = this.host.find("#divContent");
            var m = this.host.find("#divVScroll");
            var e = this.host.find("#divHScroll");
            var d = e.css("display") != "none";
            var g = m.css("display") != "none";
            b.css({
                height: (l.height - (d ? e.height() + 4 : 0)) + "px"
            });
            b.css({
                width: (l.width - (g ? m.width() + 4 : 0)) + "px"
            });
            var k = l.height;
            if (l.height == this.getHeight()) {
                k = l.height - c - ((d) ? e.height() + 4 : 0);
                if (k < 0) {
                    k = l.height
                }
            }
            ...
            var f = l.width;
            if (l.width == this.getWidth()) {
                f = l.width - i - ((g) ? m.width() + 4 : 0);
                if (f < 0) {
                    f = l.width
                }
            }
            this._pivotColumns.x = i;
        ...
        SynchronizeScrollBars: function() {
            var q = false;
            var e = false;
            var o = this.host.find("#divVScroll");
            var i = this.host.find("#divHScroll");
            var g = i.css("display") != "none";
            var k = o.css("display") != "none";
            var d = i.height();
            var l = false;
            var n = false;
            ...
            if (e) {
                q = q || (this.scrollableAreaSize.height > this.getHeight() - d)
            }
            if (q) {
                if (!k) {
                    l = true
                ...
                this.setElementPosition(o[0], this.getWidth() - d - 4, 0);
                this.setElementSize(o[0], d, c);
                o.jqxScrollBar("min", 0);
                var j = this.scrollableAreaSize.height - (this.getHeight() - (e ? d : 0)) + 4;
                if (j != o.jqxScrollBar("max")) {
                    o.jqxScrollBar("max", j)
                }
                if (this.VerticalScrollBarSmallChange != undefined) {
                    o.jqxScrollBar("step", this.VerticalScrollBarSmallChange)
                } else {
                    o.jqxScrollBar("step", 10)
                }
                var m = this.scrollableAreaSize.height / 10;
                if (m < 10) {
                    m = 10
                }
                if (this.VerticalScrollBarLargeChange != undefined) {
                    m = verticalScrollBarLargeChange
                }
                if (o.jqxScrollBar("largestep") != m) {
                    o.jqxScrollBar("largestep", m)
                }
                if (o.jqxScrollBar("largestep") < o.jqxScrollBar("step")) {
                    o.jqxScrollBar("largestep", o.jqxScrollBar("step"))
                }
                if (this.rtl) {} else {}
            } else {
                if (k) {
            ...
            if (e) {
                ...
                var p = this.getWidth() - (q ? d + 5 : 0);
                if (p < 0 || p == undefined) {
                    p = 0
                }
                this.setElementPosition(i[0], 0, this.getHeight() - d - 4);
                this.setElementSize(i[0], p, d);
                if (i.jqxScrollBar("min") != 0) {
                    i.jqxScrollBar("min", 0)
                }
                var f = this.scrollableAreaSize.width - (this.getWidth() - (q ? d : 0)) + 4;
                if (i.jqxScrollBar("max") != f) {
                    i.jqxScrollBar("max", f)
                }
                if (this.HorizontalScrollBarSmallChange != undefined) {
                    i.jqxScrollBar("step", this.HorizontalScrollBarSmallChange)
                } else {
                    i.jqxScrollBar("step", 10)
                }
                ...
                i.jqxScrollBar("largestep", b);
                if (i.jqxScrollBar("largestep") < i.jqxScrollBar("largestep")) {
                    i.jqxScrollBar("largestep", i.jqxScrollBar("step"))
                }
            } else {
                if (g) {
                    n = true
                }
                i.jqxScrollBar("value", 0);
                i[0].style.display = "none"
            }
            e = e && this.scrollBarsEnabled;
            q = q && this.scrollBarsEnabled;
            if (e != (i[0].display == "block")) {
                i[0].display = e ? "block" : "none";
                n = true
            }
            if (q != (o[0].display == "block")) {
                o[0].display = q ? "block" : "none";
                l = true
            }
            ...
            i.jqxScrollBar("refresh");
            o.jqxScrollBar("refresh")
        },
        ...
        onMouseLeftButtonUp: function(c) {
            var k = this;
            for (var l in k._scrollBarPositions) {
                if (this._scrollBarPositions[l].visible && this.isPtInRect(k._currentPosition, k._scrollBarPositions[l].rect)) {
                    if (k._isMouseCaptured()) {
                        k._releaseMouseCapture()
                    }
                    k._isMouseLeftButtonDown = false;
                    return
                }
            }
            if (k._isMouseCaptured()) {
            ...
            if (k._itemMenuButtonMouseOver || k._isContextMenuOpen) {
                return
            }
            k.canDrag = false;
            ...
            var d = k._pivotCells._hitTest(k._currentPosition);
            if (d && e) {
                var i = k._raisePivotCellMouseEvent(d.pivotRow, d.pivotColumn, "pivotcellmouseup", "left");
                if (i) {
                    return
                }
            }
            if (k._colResizeState == "RESIZING") {
                k._colResizeState = "NO_RESIZE";
                k._updateCursor("ARROW");
                k._pivotColumns._renderRequired = true;
                k._pivotRows._renderRequired = true;
                var m = {
                    x: k.resizingItem.x + k.resizingItem.hierarchy.x - k._offsetX,
                    y: k.resizingItem.y + k.resizingItem.hierarchy.y - k._offsetY
                };
                if (this.isHorizontalResize) {
                    k.resizingItem.setWidth(Math.max(k.resizingItem.minimumWidth, Math.abs(k._currentPosition.x - m.x)))
                } else {
                    k.resizingItem.setHeight(Math.max(k.resizingItem.minimumHeight, Math.abs(k._currentPosition.y - m.y)))
                }
                a("body").find("#" + k._resizeLineId).hide();
                k.resizingItem = null;
                if (k.resizeTooltipEnabled) {}
                k._isMouseLeftButtonDown = false;
                k._internalRefresh();
                return
            }
            ...
            var j = k._itemHitTest(k._currentPosition, f);
            if (j != null) {
            ...
            if (k._canDrop(j)) {
                ...
                if (k.dragElement && k.dragElement.style.display == "block") {
                    k._endDrag(draggingItem);
                    b = true
                }
            }
            if (b) {
            ...
            k._isMouseLeftButtonDown = false;
            if (e && k.activeEditor.Editor == null) {
                k._updateSelection()
            }
        },
        onMouseLeftButtonDown: function(g) {
            for (var i in this._scrollBarPositions) {
                if (this._scrollBarPositions[i].visible && this.isPtInRect(this._currentPosition, this._scrollBarPositions[i].rect)) {
                    this._captureMouse();
                    return
                }
            }
        ...
        _itemMouseMove: function(b, g) {
            ...
            if (g.isColumn) {
                j.x += g.hierarchy.x - this._offsetX
            } else {
                j.y += g.hierarchy.y - this._offsetY
            }
            if (g.IsRowsHierarchyItem && _pivotRows.compactStyleRenderingEnabled) {
                j.height = g.height
            }
            j.right = j.x + j.width;
            j.bottom = j.y + j.height;
            if (Math.abs(j.right - b.x) <= 4 && b.y >= j.y && b.y <= j.bottom) {
            ...
            if (!g.isColumn && Math.abs(j.bottom - b.y) <= 3) {
            ...
            if (g.hierarchy.sortable && f.items.length > 0) {
                this._hitTestShowItemMenuElement(b, g, j)
            }
        },
        ...
        _hitTestShowItemMenuElement: function(b, f, g) {
            ...
            if (this._isContextMenuOpen || f.valueItems.length > 0 || !(b.x < g.right && b.x > g.x && b.y >= g.y && b.y <= g.bottom)) {
                return
            }
            ...
            e.x -= f.hierarchy.x - (f.hierarchy.viewPort.x - f.hierarchy.x);
            e.y -= f.hierarchy.y - (f.hierarchy.viewPort.y - f.hierarchy.y);
            menuRect = {
                x: f.x + g.width - 18,
                y: f.y + (g.height - 16) / 2 + 1,
                width: 16,
                height: 16
            };
            ...
            if (f.isColumn) {
                menuRect.x += f.hierarchy.x - this._offsetX
            } else {
                menuRect.y += f.hierarchy.y - this._offsetY
            }
            ...
            if (this.isPtInRect({
                    ...
                    x: menuRect.x,
                    y: menuRect.y + menuRect.height
                }, d) && this.isPtInRect({
                    x: menuRect.x + menuRect.width,
                    y: menuRect.y
                }, d) && this.isPtInRect({
                    x: menuRect.x + menuRect.width,
                    y: menuRect.y + menuRect.height
                ...
                this._menuElement._itemMouseOver = f;
                a(this._menuElement._itemMouseOver._element).find("#sortElement").hide();
                if (!f._currentCustomContent) {
                    var c = a(f._element).css("background-color");
                    this._menuElement.style["background-color"] = c
                }
                if (f.isColumn) {
                    menuRect.x += this._offsetX - f.hierarchy.x
                } else {
                    menuRect.y += this._offsetY - f.hierarchy.y
                }
                if (this.isPtInRect({
                        x: e.x,
                        y: e.y
        ...
        _handleMouseMove: function(d) {
            ...
            var k = this._currentPosition;
            var j = null;
            if (this.isInHierarchyViewPort({
                    x: k.x,
                    y: k.y
                }, this._pivotColumns)) {
                j = this._pivotColumns.hitTest(k)
            }
            var c = null;
            if (this.isInHierarchyViewPort({
                    x: k.x,
                ...
                c = this._pivotRows.hitTest(k)
            }
            this._itemMenuButtonMouseOver = false;
            if (j != null || c != null) {
                var i = j == null ? c : j;
                this.gridCellMouseOver = null;
                this._itemMouseMove(k, i);
                if (this._focusedItem != i) {
                    this._focusedItem = i;
                ...
                var f = {};
                if (this.CellsHighlightOnHierarchyItemMoveEnabled && ((i.IsRowsHierarchyItem && (this.CellsHighlightMode == "CELLS_HIGHLIGHT_ROW")) || (i.isColumn && (this.CellsHighlightMode == "CELLS_HIGHLIGHT_COLUMN")))) {
                    if (i.isColumn) {
                        f = {
                            x: i.x,
                            y: 0,
                        ...
                        f = {
                            ...
                            y: i.y,
                            width: this._pivotColumns.getWidth(),
                            height: i.getDisplayHeight()
                        }
                    }
                    if ((i.isColumn && this.isGroupingEnabled && this.groupingColumns.length > 0) || (i.IsRowsHierarchyItem && this._pivotRows.isOnRowDetails(this._currentPosition, i))) {
                        f = {
                            x: 0,
                            y: 0,
                            width: 0,
            ...
            var e = this._pivotCells._hitTest(k);
            if (this._isMouseLeftButtonDown && e) {
                if (this.gridCellMouseOver == null || this.gridCellMouseOver.pivotRow != c || this.gridCellMouseOver.pivotColumn != j) {
        ...
        _doResize: function(b) {
            ...
            if (this.isHorizontalResize) {
                var i = b.x - j.x;
                if (i < this.resizingItem.minimumWidth) {
                    return
                }
                var f = {
                    x: b.x + this._rect.x,
                ...
                if (i >= this.resizingItem.minimumWidth && i <= this.resizingItem.maximumWidth) {
                    if (this.resizeTooltipEnabled) {
                        this._resizeTooltip.Content = "width: " + i + " pixels"
                    }
                    g = true
                }
            } else {
            ...
            if (g) {
                if (this.resizeTooltipEnabled) {
                    ...
                    _resizeTooltip.setValue(Canvas.LeftProperty, b.x);
                    _resizeTooltip.setValue(Canvas.TopProperty, b.y);
        ...
        _updateSelection: function() {
            ...
            var j = this._itemHitTest(this._selectStartPosition, q);
            if (j != null) {
                if (!(!j.isColumn && this._pivotRows.compactStyleRenderingEnabled)) {
                    j = j._getFirstVisibleLeaf(j)
                }
                if (j.isColumn) {
                    ...
                    this._colItemRangeSelectionBeg = j
                } else {
                    ...
                    this._rowItemRangeSelectionBeg = j
                }
            } else {
                var i = this._pivotCells._hitTest(this._selectStartPosition);
                if (i) {
                    this._internalSelectMode = "CELLS_SELECT";
                    if (this.selectionMode == "FULL_ROW_SELECT") {
                        this._internalSelectMode = "ROW_SELECT"
            ...
            if (this._internalSelectMode == "COL_SELECT" || this._internalSelectMode == "ROW_SELECT") {
                if (j != null) {
                    ...
                    this._pivotCells.hitTest(b, i);
                    if (i != null) {
                        this._colItemRangeSelectionEnd = i.pivotColumn;
                        this._rowItemRangeSelectionEnd = i.pivotRow
                    } else {
                        this._colItemRangeSelectionEnd = null;
                        this._rowItemRangeSelectionEnd = null
                    }
            ...
            if (this._internalSelectMode == "CELLS_SELECT") {
                var i = this._pivotCells._hitTest(this._selectStartPosition);
                this._colItemRangeSelectionBeg = i.pivotColumn;
                this._rowItemRangeSelectionBeg = i.pivotRow;
                if (!i) {
                    this._endSelectionUpdate();
                    this._internalRefresh();
                    return
            ...
            this._adjustSelectedItemsOrder(m);
            if (this._internalSelectMode == "CELLS_SELECT") {
                var v = this._pivotRows._getVisibleLeafLevelItems();
                var o = this._pivotColumns._getVisibleLeafLevelItems();
                var u = this._pivotRows._pointToLeafItemIndexAbsolute(this._selectStartPosition);
                var p = this._pivotRows._pointToLeafItemIndexAbsolute(b);
                var k = this._pivotColumns._pointToLeafItemIndexAbsolute(this._selectStartPosition);
                ...
                for (var n = u; n <= p && n < v.length; n++) {
                    var e = v[n];
                    for (var s = k; s <= f && s < o.length; s++) {
                        var l = o[s];
                        this._pivotCells._internalSelectCell(e, l)
                    }
                }
...
(function(a) {
    ...
    a.extend(a.jqx.jqxPivotGrid.pivotCells.prototype, {
        ...
        setCellValue: function(k, g, f) {
            if (k == null || g == null) {
                return
            }
            var d = this.parentPivotGrid.getCellId(g, k);
            var b = this.getCellDataSource(k, g);
            var c = k.BoundFieldIndex != -1 && g.BoundFieldIndex != -1;
            var j = false;
            if (dsType == "DataBound" && c) {
                j = this.parentPivotGrid.OnCellValueChanging(k, g, f);
                if (j) {
                    return
                }
                try {
                    this.parentPivotGrid.setCellValueFromDataSourceNonPivot(k, g, f)
                } catch (i) {
                    return
                }
                this.cellProperties.setPropertyValue("CellValue", d, null);
                this.parentPivotGrid.OnCellValueChanged(k, g);
                return
            } else {
                if (dsType == "DataBoundPivot") {
            ...
            var j = this.parentPivotGrid.OnCellValueChanging(k, g, f);
            if (j) {
                return
            }
            this.SetCellDataSource(k, g, "Static");
            this.cellProperties.setPropertyValue("CellValue", d, f);
        ...
        getCellValue: function(i, f) {
            var d = null;
            if (this.parentPivotGrid._pivotColumns.isGroupingColumn(f)) {
                return null
            }
            var c = this.parentPivotGrid.getCellId(f, i);
            var b = this.getCellDataSource(i, f);
            if (i.isTotal || f.isTotal) {
                b = "Virtual"
            }
            switch (b) {
                case "Virtual":
                    d = this.parentPivotGrid.onCellValueNeeded(i, f);
                    this.cellProperties.setDirty(c);
                    if (d == null && this.parentPivotGrid.bindingState == "BoundPivot" && (i.isTotal || f.isTotal)) {
                        d = this.parentPivotGrid.getCellValueFromDataSource(i, f)
                    }
                    break;
                case "DataBoundPivot":
                    d = this.cellProperties.getPropertyValue("CellValue", c);
                    if (d == null) {
                        d = this.parentPivotGrid.source.getCellValue(i.adapterItem, f.adapterItem);
                ...
                case "DataBound":
                    ...
                    if (d == null) {
                        try {
                            d = this.parentPivotGrid.getCellValueFromDataSourceNonPivot(i, f)
                        } catch (g) {
                            return null
                        }
                        if (this.cellProperties.getPropertyCount("CellValue") < 4000000) {
...
(function(a) {
    ...
    a.extend(a.jqx.jqxPivotGrid.pivotItem.prototype, {
        ...
        _autoResizeBestItemContent: function(b) {
            ...
            if (this.getWidth() < sz.width || (b == "default" && this.adapterItem.boundField && !isNaN(this.adapterItem.boundField.width))) {
        ...
        render: function(j, g) {
            ...
            if (this.isExpanded) {
                for (var e = 0; e < this.items.length; e++) {
                    var k = this.items[e];
                    if (k.isHidden || k.isFiltered) {
                        continue
                    }
                    if (!this.isColumn) {
                        var f = j;
                        f += c ? 0 : this.getWidth();
                        if (!k.render(f, this.y + d)) {
                            break
                        }
                        d += k.getHeightWithChildren()
                    } else {
                        if (!k.render(this.x + d, g + this.getTotalHeight())) {
                            break
                        }
                        d += k.getWidthWithChildren()
                    }
                }
            }
            for (var e = 0; e < this.valueItems.length; e++) {
                var k = this.valueItems[e];
                if (k.isHidden || k.isFiltered) {
                    continue
                }
                if (!this.isColumn) {
    ...
    a.extend(a.jqx.jqxPivotGrid.hierarchy.prototype, {
        ...
        _fnAscSortComparer: function(c, b) {
            var i = c.hierarchy.parentPivotGrid;
            var e = c.isColumn ? i._pivotRows : i._pivotColumns;
            var j = e._sortItem;
            if (!j) {
                return 0
            }
            ...
            var g = i._pivotCells;
            var f = c.isColumn ? g.getCellValue(j, c) : g.getCellValue(c, j);
            var d = b.isColumn ? g.getCellValue(j, b) : g.getCellValue(b, j);
        ...
        _binSearchItems2: function(g, j, f, k) {
            var d = f;
            var e = k;
            if (e == d) {
                return -1
            ...
            var b = g[0].isColumn;
            while (d < e) {
                var i = parseInt((d + e) / 2);
                var c = g[i];
                if (b) {
                    if (c.x > j.x) {
                        e = i
                    } else {
                        if ((i + 1 < e ? g[i + 1].x : c.x + c.getWidth()) < j.x) {
                            d = i + 1
                        } else {
                            return i
                        }
                    ...
                    if (c.y > j.y) {
                        ...
                        if ((i + 1 < e ? g[i + 1].y : c.y + c.getTotalHeight()) < j.y) {
                            d = i + 1
                        } else {
                            return i
                        }
        ...
        hitTest: function(c) {
            ...
            var i = this._binSearchItems(f, e);
            if (i == -1) {
                return null
            } else {
                var d = f[i];
        ...
        _applySelectionToParentItem: function(j) {
            var c = j.parentItem;
...
(function(a) {
    a.extend(a.jqx._jqxPivotGrid.prototype, {
        ...
        _handleCellsKeyboardNavigation: function(e) {
            var l = this._cellKBRangeSelectionEnd;
            var f = undefined;
            var n = this;
            if (!l) {
                return false
            ...
            if (e.keyCode == 37) {
                f = this._pivotCells.getNextCell(l, "left")
            }
            if (e.keyCode == 38) {
                f = this._pivotCells.getNextCell(l, "top")
            } else {
                if (e.keyCode == 39) {
                    f = this._pivotCells.getNextCell(l, "right")
                } else {
                    if (e.keyCode == 40) {
                        f = this._pivotCells.getNextCell(l, "bottom")
                    }
                }
            }
            if (f != null) {
                ...
                var m = Math.min(this._cellKBRangeSelectionStart.pivotColumn._lfIndex, this._cellKBRangeSelectionEnd.pivotColumn._lfIndex);
                var i = Math.max(this._cellKBRangeSelectionStart.pivotColumn._lfIndex, this._cellKBRangeSelectionEnd.pivotColumn._lfIndex);
                var o = Math.min(this._cellKBRangeSelectionStart.pivotRow._lfIndex, this._cellKBRangeSelectionEnd.pivotRow._lfIndex);
                var j = Math.max(this._cellKBRangeSelectionStart.pivotRow._lfIndex, this._cellKBRangeSelectionEnd.pivotRow._lfIndex);
                for (var k = m; k <= i; k++) {
                    for (var b = o; b <= j; b++) {
                        var g = this._pivotColumns.visibleLeafItems[k];
